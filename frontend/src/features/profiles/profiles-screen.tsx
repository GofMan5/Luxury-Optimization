...
export default function ProfilesScreen() {
  ...
  const [section, setSection] = useState<TweakSection>('profiles')
  ...
  return (
    <div className="page">
      <PageHeader title={c.title} description={c.description} actions={section === 'profiles' ? <Button variant="quiet" onClick={() => setSection('tweaks')}><Search size={15} />{c.openCatalog}</Button> : undefined} />

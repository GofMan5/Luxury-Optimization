...
func windowsCapabilities() []Capability {
	return []Capability{
		...
		{ID: "game-boost", Available: true, Mode: "session", Detail: "game stays non-elevated; power throttling is disabled with read-back and system profile is restored after exit"},

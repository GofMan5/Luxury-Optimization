...
Use `./build.sh 1.0.7` on Linux or `./build.ps1 -Version 1.0.7` on Windows to verify every recovery-CLI target. Build the desktop application from `frontend/` with `pnpm tauri:build`.
